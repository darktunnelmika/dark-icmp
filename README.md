...
[![Version](https://img.shields.io/badge/version-2.7.1-blue.svg)](https://github.com/mikakhadm/dark-icmp)
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/mikakhadm/dark-icmp/main/dark-icmppro.sh)
```
